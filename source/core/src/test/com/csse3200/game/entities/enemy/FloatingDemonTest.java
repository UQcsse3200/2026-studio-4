...
class FloatingDemonTest {
  ...
  void shouldTakeDamageFromPlayerWeapon() {
    ...
    Entity demon =
        NPCFactory.createFloatingDemon(
            player, new Vector2(1f, 3f), new Vector2(5f, 5f), new Vector2(10f, 3f), "images/floatingDemon.atlas");
    demon.create();
  ...
  void shouldStartDeathAnimationWhenHealthReachesZero() {
    Entity demon =
        NPCFactory.createFloatingDemon(
            new Entity(), new Vector2(1f, 3f), new Vector2(5f, 5f), new Vector2(10f, 3f), "images/floatingDemon.atlas");
    demon.create();
