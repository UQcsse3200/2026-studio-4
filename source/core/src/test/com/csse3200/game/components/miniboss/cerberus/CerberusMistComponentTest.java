...
class CerberusMistComponentTest {
  ...
  void setUp() {
    ...
    player.getEvents().addListener(CerberusMistComponent.ENTERED, (Entity source) -> entered++);
    player.getEvents().addListener(CerberusMistComponent.EXITED, (Entity source) -> exited++);
