...
/**
 * Only usable once the snake's own health drops below a threshold (Phase 2). Telegraphs, then
 * spits venom that creates a damaging pool on the ground where the player currently is, then
 * cools down before it can spit again.
 */
