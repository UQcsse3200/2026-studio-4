...
/**
 * A self-contained damage-over-time effect (poison). Not part of the Entity/Component system -
 * it's owned and driven by whichever attack applies it, since components can't be added to an
