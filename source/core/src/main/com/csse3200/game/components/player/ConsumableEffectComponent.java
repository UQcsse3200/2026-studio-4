...
public class ConsumableEffectComponent extends Component {
     ...
     * attack/collision handling) should check this before applying damage to the player, and skip
     * the damage if true. This is the integration point other teams' combat code needs to call.
     */
